...
<div class="containerd">
    <div class="box">
        <div class="animation">
            <div class="one-d spin-one"></div>
            <div class="two-d spin-two"></div>
            <div class="three-d spin-one"></div>
        </div>
        <h1 style="text-align: center; font-size: 43px;">Under maintenance</h1>
        <p style="text-align: center; font-size: 19px;">Section under maintenance. </p>
        <p style="text-align: center; font-size: 19px;">Sorry for the inconvenience but we are performing some maintenance at the moment.</p>
    </div>
</div>
